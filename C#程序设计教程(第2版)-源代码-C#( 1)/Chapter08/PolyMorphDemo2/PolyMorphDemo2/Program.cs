...
{   //重写从基接口ICommon继承的方法f()
    ...
    public override void g() { Console.WriteLine("Derived1.g()"); }//重写从基类继承的方法g()
    public void h() { Console.WriteLine("Derived1.h()"); }//新定义方法h()
}  
class Derived2 : ICommon
{   //重写从基接口ICommon继承的方法f()
    public void f() { Console.WriteLine("Derived2.f()"); }
    public void h() { Console.WriteLine("Derived2.h()"); } // 新定义方法h()
}
